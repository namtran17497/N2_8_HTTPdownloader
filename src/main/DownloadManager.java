...
public class DownloadManager {
	...
	public static DownloadManager getInstance() {
		...
		return sInstance;
            ...
            if (!fileURL.toLowerCase().startsWith("http://")&&!fileURL.toLowerCase().startsWith("https://")&&fileURL.endsWith(".jpg")){
                return null;
            }
            if(!fileURL.endsWith(".jpg")&&!fileURL.endsWith(".webp")&&!fileURL.endsWith(".webm")&&!fileURL.endsWith(".mp4")&&!fileURL.endsWith(".png")){
                return null;
            }
